...
export const ProcedureCard: React.FC<ProcedureCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <h4 className="text-sm sm:text-base text-gray-800 group-hover:text-blue-600 transition-colors line-clamp-2 px-1 h-[3rem] sm:h-[3.5rem] flex items-center justify-center">
        {title}
      </h4>

...
import { ChevronRight, Newspaper, Search, Phone } from "lucide-react";
...
export const HomePage: React.FC = () => {
  ...
  // Fetch committee info for hotline
  const { data: committeeInfo } = useQuery({
    queryKey: ["committee"],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url("https://hochiminhcity.gov.vn/documents/39403/49303/background-trong-dong.png")',
        }}
      >
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <div className="flex items-end justify-between mb-6 sm:mb-8">
                <div>
                  <h2 className="text-2xl sm:text-3xl text-gray-800 mb-1 sm:mb-2">
                    Tin tức mới nhất
                  </h2>
                  <p className="text-sm sm:text-base text-gray-600">
                    Cập nhật thông tin từ UBND Phường
                  </p>
                </div>
              </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {[...Array(6)].map((_, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 rounded-xl overflow-hidden shadow animate-pulse"
                        >
            ...
            <div className="bg-white border-t border-gray-200 py-10 sm:py-12 lg:py-16">
              <div className="px-4 sm:px-6 lg:px-12 text-center">
                <h2 className="text-2xl sm:text-3xl text-gray-800 mb-3 sm:mb-4">
                  Cần hỗ trợ?
                </h2>
                <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto px-4">
                  Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ cư dân. Gửi phản
                  ánh hoặc liên hệ trực tiếp với chúng tôi.
                </p>

        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button 
              ...
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg flex items-center gap-2"
            >
